...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_49_19_gear_17t_final_v_2e25ef");
    // 步骤 2: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 6.395, 4.0);
    // 步骤 3: create_sketch
    m.Tool_CreateSketch();
    // 步骤 4: draw_line
    m.Tool_DrawLine(6.339, -0.844, 8.365, -0.511);
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.365, -0.511, 8.365, 0.511);
    // 步骤 6: draw_line
    m.Tool_DrawLine(8.365, 0.511, 6.339, 0.844);
    // 步骤 7: draw_line
    ...
    m.Tool_CreateSketch();
    // 步骤 12: draw_line
    m.Tool_DrawLine(6.151, 1.748, 8.062, 2.289);
    // 步骤 13: draw_line
    m.Tool_DrawLine(8.062, 2.289, 7.557, 3.629);
    // 步骤 14: draw_line
    m.Tool_DrawLine(7.557, 3.629, 5.766, 2.769);
    // 步骤 15: draw_line
    m.Tool_DrawLine(5.766, 2.769, 6.151, 1.748);
    // 步骤 16: close_sketch
    m.Tool_CloseSketch();
    // 步骤 17: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 20: draw_line
    m.Tool_DrawLine(5.218, 3.673, 6.837, 4.812);
    // 步骤 21: draw_line
    m.Tool_DrawLine(6.837, 4.812, 5.916, 5.916);
    // 步骤 22: draw_line
    m.Tool_DrawLine(5.916, 5.916, 4.515, 4.515);
    // 步骤 23: draw_line
    m.Tool_DrawLine(4.515, 4.515, 5.218, 3.673);
    // 步骤 24: close_sketch
    m.Tool_CloseSketch();
    // 步骤 25: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 28: draw_line
    m.Tool_DrawLine(3.673, 5.218, 4.812, 6.837);
    // 步骤 29: draw_line
    m.Tool_DrawLine(4.812, 6.837, 3.629, 7.557);
    // 步骤 30: draw_line
    m.Tool_DrawLine(3.629, 7.557, 2.769, 5.766);
    // 步骤 31: draw_line
    m.Tool_DrawLine(2.769, 5.766, 3.673, 5.218);
    // 步骤 32: close_sketch
    m.Tool_CloseSketch();
    // 步骤 33: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 36: draw_line
    m.Tool_DrawLine(1.748, 6.151, 2.289, 8.062);
    // 步骤 37: draw_line
    m.Tool_DrawLine(2.289, 8.062, 0.74, 8.35);
    // 步骤 38: draw_line
    m.Tool_DrawLine(0.74, 8.35, 0.565, 6.372);
    // 步骤 39: draw_line
    m.Tool_DrawLine(0.565, 6.372, 1.748, 6.151);
    // 步骤 40: close_sketch
    m.Tool_CloseSketch();
    // 步骤 41: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 44: draw_line
    m.Tool_DrawLine(-0.565, 6.372, -0.74, 8.35);
    // 步骤 45: draw_line
    m.Tool_DrawLine(-0.74, 8.35, -2.289, 8.062);
    // 步骤 46: draw_line
    m.Tool_DrawLine(-2.289, 8.062, -1.748, 6.151);
    // 步骤 47: draw_line
    m.Tool_DrawLine(-1.748, 6.151, -0.565, 6.372);
    // 步骤 48: close_sketch
    m.Tool_CloseSketch();
    // 步骤 49: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 52: draw_line
    m.Tool_DrawLine(-2.769, 5.766, -3.629, 7.557);
    // 步骤 53: draw_line
    m.Tool_DrawLine(-3.629, 7.557, -4.812, 6.837);
    // 步骤 54: draw_line
    m.Tool_DrawLine(-4.812, 6.837, -3.673, 5.218);
    // 步骤 55: draw_line
    m.Tool_DrawLine(-3.673, 5.218, -2.769, 5.766);
    // 步骤 56: close_sketch
    m.Tool_CloseSketch();
    // 步骤 57: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 60: draw_line
    m.Tool_DrawLine(-4.515, 4.515, -5.916, 5.916);
    // 步骤 61: draw_line
    m.Tool_DrawLine(-5.916, 5.916, -6.837, 4.812);
    // 步骤 62: draw_line
    m.Tool_DrawLine(-6.837, 4.812, -5.218, 3.673);
    // 步骤 63: draw_line
    m.Tool_DrawLine(-5.218, 3.673, -4.515, 4.515);
    // 步骤 64: close_sketch
    m.Tool_CloseSketch();
    // 步骤 65: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 68: draw_line
    m.Tool_DrawLine(-5.766, 2.769, -7.557, 3.629);
    // 步骤 69: draw_line
    m.Tool_DrawLine(-7.557, 3.629, -8.062, 2.289);
    // 步骤 70: draw_line
    m.Tool_DrawLine(-8.062, 2.289, -6.151, 1.748);
    // 步骤 71: draw_line
    m.Tool_DrawLine(-6.151, 1.748, -5.766, 2.769);
    // 步骤 72: close_sketch
    m.Tool_CloseSketch();
    // 步骤 73: extrude
    m.Tool_Extrude(4.0);
    ...
    // 步骤 145: extrude
    m.Tool_Extrude(4.0);
    // 步骤 146: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 147: hole
    m.Tool_Hole(0.0, 0.0, 4.0, 4.0, "through");

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_49_19_gear_17t_final_v_2e25ef.prt");
  }
}
