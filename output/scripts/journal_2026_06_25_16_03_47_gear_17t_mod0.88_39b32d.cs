...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_03_47_gear_17t_mod0.88_39b32d");
    // 步骤 2: create_sketch
    m.Tool_CreateSketch();
    // 步骤 3: draw_arc
    m.Tool_DrawArc(0.0, 0.0, 10.0, -5.309, 5.309);
    // 步骤 4: draw_line
    m.Tool_DrawLine(8.345, 0.776, 6.368, 0.592);
    // 步骤 5: draw_line
    m.Tool_DrawLine(6.368, 0.592, 6.368, -0.592);
    // 步骤 6: draw_line
    m.Tool_DrawLine(6.368, -0.592, 8.345, -0.776);
    // 步骤 7: close_sketch
    m.Tool_CloseSketch();
    // 步骤 8: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 10: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 6.9, 4.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_03_47_gear_17t_mod0.88_39b32d.prt");
  }
}
