...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_28_12_19_34_GB_T6170_M10_Hex_bb2269");
    // 步骤 2: create_sketch_on_plane
    m.Tool_CreateSketch();
    // 步骤 3: draw_polyline
    m.Tool_DrawPolyline(new Point3d[]{new Point3d(-4.6188, 8.0, 0), new Point3d(4.6188, 8.0, 0), new Point3d(9.2376, 0.0, 0), new Point3d(4.6188, -8.0, 0), new Point3d(-4.6188, -8.0, 0), new Point3d(-9.2376, 0.0, 0), new Point3d(-4.6188, 8.0, 0)});
    // 步骤 4: close_sketch
    m.Tool_CloseSketch();
    // 步骤 5: extrude
    m.Tool_Extrude(8.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 7: draw_circle
    m.Tool_DrawCircle(0.0, 0.0, 4.2);
    // 步骤 8: close_sketch
    m.Tool_CloseSketch();
    // 步骤 9: extrude_cut
    m.Tool_ExtrudeCut(8.0);
    // 步骤 10: chamfer
    m.Tool_Chamfer(0.8);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_28_12_19_34_GB_T6170_M10_Hex_bb2269.prt");
  }
}
