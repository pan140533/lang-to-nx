...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_06_34_gear_17t_full_58ee11");
    // 步骤 2: pad
    m.Tool_Pad(7.3875, 0.0, 1.985, 1.39, 4.0);
    // 步骤 3: pattern_circular
    m.Tool_PatternCircular("", 17, 21.176470588235293);
    // 步骤 4: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 6.5, 4.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_06_34_gear_17t_full_58ee11.prt");
  }
}
