...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("test_complex");
    // 步骤 2: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 30.0, 20.0);

    m.Tool_SaveModel(@"E:/NX/Lang-to-NX-MCP/output\\models\\test_complex.prt");
  }
}
...
public class NXModeler
{
  ...
  {
    // Sweep: C# SweptBuilder1 API needs Journal (Spine is read-only)
    Console.WriteLine("[!] Sweep: C# SweptBuilder1.Spine needs Journal ({0} pts)", pathPoints != null ? pathPoints.Length.ToString() : "0");
  }
