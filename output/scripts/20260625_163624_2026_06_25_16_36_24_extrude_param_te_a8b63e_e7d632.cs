...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_36_24_extrude_param_te_a8b63e");
    // 步骤 2: create_sketch
    m.Tool_CreateSketch();
    // 步骤 3: draw_circle
    m.Tool_DrawCircle(0.0, 0.0, 10.0);
    // 步骤 4: close_sketch
    m.Tool_CloseSketch();
    // 步骤 5: extrude
    m.Tool_Extrude(10.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_36_24_extrude_param_te_a8b63e.prt");
  }
}
