...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_45_42_pattern_volume_t_4cc0df");
    // 步骤 2: cylinder
    ...
    // 步骤 10: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 11: pattern_circular
    m.Tool_PatternCircular("", 17, 21.176470588235293);
    // ? 跳过未实现: measure_volume
    // 步骤 13: hole
    m.Tool_Hole(0.0, 0.0, 4.0, 4.0, "through");
    // ? 跳过未实现: measure_volume

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_45_42_pattern_volume_t_4cc0df.prt");
  }
}
