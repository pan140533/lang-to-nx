...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_08_23_gear_17t_with_ho_eeffa9");
    // 步骤 2: create_sketch
    m.Tool_CreateSketch();
    // 步骤 3: draw_line
    m.Tool_DrawLine(6.337, -0.848, 8.361, -0.55);
    // 步骤 4: draw_line
    m.Tool_DrawLine(8.361, -0.55, 8.361, 0.55);
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.361, 0.55, 6.337, 0.848);
    // 步骤 6: draw_line
    m.Tool_DrawLine(6.337, 0.848, 6.337, -0.848);
    // 步骤 7: close_sketch
    m.Tool_CloseSketch();
    // 步骤 8: extrude
    m.Tool_Extrude(10.0);
    // 步骤 9: pattern_circular
    ...
    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_08_23_gear_17t_with_ho_eeffa9.prt");
  }
}
