...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_09_34_gear_17t_final_99cd32");
    // 步骤 2: create_sketch
    m.Tool_CreateSketch();
    // 步骤 3: draw_line
    m.Tool_DrawLine(6.339, -0.845, 8.365, -0.511);
    // 步骤 4: draw_line
    m.Tool_DrawLine(8.365, -0.511, 8.365, 0.511);
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.365, 0.511, 6.339, 0.845);
    // 步骤 6: draw_line
    m.Tool_DrawLine(6.339, 0.845, 6.339, -0.845);
    // 步骤 7: close_sketch
    m.Tool_CloseSketch();
    // 步骤 8: extrude
    m.Tool_Extrude(10.0);
    ...
    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_09_34_gear_17t_final_99cd32.prt");
  }
}
