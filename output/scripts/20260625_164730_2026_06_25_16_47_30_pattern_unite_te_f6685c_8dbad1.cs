...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_47_30_pattern_unite_te_f6685c");
    // 步骤 2: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 5.0, 2.0);
    // 步骤 3: create_sketch
    m.Tool_CreateSketch();
    // 步骤 4: draw_line
    m.Tool_DrawLine(6.0, -1.0, 8.0, -1.0);
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.0, -1.0, 8.0, 1.0);
    // 步骤 6: draw_line
    m.Tool_DrawLine(8.0, 1.0, 6.0, 1.0);
    // 步骤 7: draw_line
    m.Tool_DrawLine(6.0, 1.0, 6.0, -1.0);
    // 步骤 8: close_sketch
    m.Tool_CloseSketch();
    // 步骤 9: extrude
    m.Tool_Extrude(2.0);
    ...
    m.Tool_PatternCircular("", 4, 90.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_47_30_pattern_unite_te_f6685c.prt");
  }
}
