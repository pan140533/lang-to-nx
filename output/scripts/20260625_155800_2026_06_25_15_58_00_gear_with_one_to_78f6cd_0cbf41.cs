...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_15_58_00_gear_with_one_to_78f6cd");
    // 步骤 2: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 6.395, 4.0);
    // 步骤 3: block
    m.Tool_Block(6.4, -0.7, 0.0, 2.0, 1.4, 4.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_15_58_00_gear_with_one_to_78f6cd.prt");
  }
}
