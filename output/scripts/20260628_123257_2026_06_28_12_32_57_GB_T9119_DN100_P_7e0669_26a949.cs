...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_28_12_32_57_GB_T9119_DN100_P_7e0669");
    // 步骤 2: create_sketch_on_plane
    m.Tool_CreateSketch();
    // 步骤 3: draw_circle
    m.Tool_DrawCircle(0.0, 0.0, 110.0);
    // 步骤 4: close_sketch
    m.Tool_CloseSketch();
    // 步骤 5: extrude
    m.Tool_Extrude(24.0);
    // 步骤 6: create_sketch_on_plane
    m.Tool_CreateSketch();
    // 步骤 7: draw_circle
    m.Tool_DrawCircle(0.0, 0.0, 55.0);
    // 步骤 8: close_sketch
    m.Tool_CloseSketch();
    // 步骤 9: extrude_cut
    m.Tool_ExtrudeCut(24.0);
    // 步骤 10: create_sketch_on_plane
    m.Tool_CreateSketch();
    // 步骤 11: draw_circle
    m.Tool_DrawCircle(0.0, 0.0, 71.0);
    // 步骤 12: close_sketch
    m.Tool_CloseSketch();
    // 步骤 13: extrude_from
    m.Tool_ExtrudeFrom(24.0, 2.0);
    // 步骤 14: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 15: create_sketch_on_plane
    m.Tool_CreateSketch();
    // 步骤 16: draw_circle
    m.Tool_DrawCircle(90.0, 0.0, 9.0);
    // 步骤 17: close_sketch
    m.Tool_CloseSketch();
    // 步骤 18: extrude
    m.Tool_Extrude(26.0);
    // 步骤 19: boolean_subtract
    m.Tool_BooleanSubtract("", "");
    // 步骤 20: pattern_circular
    m.Tool_PatternCircular("", 8, 360.0);

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_28_12_32_57_GB_T9119_DN100_P_7e0669.prt");
  }
}
