...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_53_47_gear_17t_final_c_b97971");
    // 步骤 2: cylinder
    m.Tool_Cylinder(0.0, 0.0, 0.0, 6.395, 4.0);
    // 步骤 3: create_sketch
    m.Tool_CreateSketch();
    // 步骤 4: draw_line
    m.Tool_DrawLine(6.339, -0.844, 8.364, -0.512);
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.364, -0.512, 8.364, 0.512);
    // 步骤 6: draw_line
    m.Tool_DrawLine(8.364, 0.512, 6.339, 0.844);
    // 步骤 7: draw_line
    m.Tool_DrawLine(6.339, 0.844, 6.339, -0.844);
    // 步骤 8: close_sketch
    m.Tool_CloseSketch();
    // 步骤 9: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 12: draw_line
    m.Tool_DrawLine(6.216, 1.503, 7.984, 2.545);
    // 步骤 13: draw_line
    m.Tool_DrawLine(7.984, 2.545, 7.615, 3.499);
    // 步骤 14: draw_line
    m.Tool_DrawLine(7.615, 3.499, 5.606, 3.077);
    // 步骤 15: draw_line
    m.Tool_DrawLine(5.606, 3.077, 6.216, 1.503);
    // 步骤 16: close_sketch
    m.Tool_CloseSketch();
    // 步骤 17: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 20: draw_line
    m.Tool_DrawLine(5.253, 3.647, 6.526, 5.257);
    // 步骤 21: draw_line
    m.Tool_DrawLine(6.526, 5.257, 5.837, 6.013);
    // 步骤 22: draw_line
    m.Tool_DrawLine(5.837, 6.013, 4.116, 4.894);
    // 步骤 23: draw_line
    m.Tool_DrawLine(4.116, 4.894, 5.253, 3.647);
    // 步骤 24: close_sketch
    m.Tool_CloseSketch();
    // 步骤 25: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 28: draw_line
    m.Tool_DrawLine(3.581, 5.298, 4.186, 7.259);
    // 步骤 29: draw_line
    m.Tool_DrawLine(4.186, 7.259, 3.27, 7.716);
    // 步骤 30: draw_line
    m.Tool_DrawLine(3.27, 7.716, 2.07, 6.051);
    // 步骤 31: draw_line
    m.Tool_DrawLine(2.07, 6.051, 3.581, 5.298);
    // 步骤 32: close_sketch
    m.Tool_CloseSketch();
    // 步骤 33: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 36: draw_line
    m.Tool_DrawLine(1.426, 6.234, 1.281, 8.281);
    // 步骤 37: draw_line
    m.Tool_DrawLine(1.281, 8.281, 0.262, 8.376);
    // 步骤 38: draw_line
    m.Tool_DrawLine(0.262, 8.376, -0.256, 6.39);
    // 步骤 39: draw_line
    m.Tool_DrawLine(-0.256, 6.39, 1.426, 6.234);
    // 步骤 40: close_sketch
    m.Tool_CloseSketch();
    // 步骤 41: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 44: draw_line
    m.Tool_DrawLine(-0.923, 6.328, -1.797, 8.185);
    // 步骤 45: draw_line
    m.Tool_DrawLine(-1.797, 8.185, -2.781, 7.905);
    // 步骤 46: draw_line
    m.Tool_DrawLine(-2.781, 7.905, -2.547, 5.866);
    // 步骤 47: draw_line
    m.Tool_DrawLine(-2.547, 5.866, -0.923, 6.328);
    // 步骤 48: close_sketch
    m.Tool_CloseSketch();
    // 步骤 49: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 52: draw_line
    m.Tool_DrawLine(-3.146, 5.567, -4.632, 6.983);
    // 步骤 53: draw_line
    m.Tool_DrawLine(-4.632, 6.983, -5.449, 6.367);
    // 步骤 54: draw_line
    m.Tool_DrawLine(-5.449, 6.367, -4.494, 4.55);
    // 步骤 55: draw_line
    m.Tool_DrawLine(-4.494, 4.55, -3.146, 5.567);
    // 步骤 56: close_sketch
    m.Tool_CloseSketch();
    // 步骤 57: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 60: draw_line
    m.Tool_DrawLine(-4.945, 4.055, -6.842, 4.838);
    // 步骤 61: draw_line
    m.Tool_DrawLine(-6.842, 4.838, -7.381, 3.968);
    // 步骤 62: draw_line
    m.Tool_DrawLine(-7.381, 3.968, -5.834, 2.619);
    // 步骤 63: draw_line
    m.Tool_DrawLine(-5.834, 2.619, -4.945, 4.055);
    // 步骤 64: close_sketch
    m.Tool_CloseSketch();
    // 步骤 65: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 68: draw_line
    m.Tool_DrawLine(-6.076, 1.995, -8.128, 2.04);
    // 步骤 69: draw_line
    m.Tool_DrawLine(-8.128, 2.04, -8.316, 1.034);
    // 步骤 70: draw_line
    m.Tool_DrawLine(-8.316, 1.034, -6.386, 0.335);
    // 步骤 71: draw_line
    m.Tool_DrawLine(-6.386, 0.335, -6.076, 1.995);
    // 步骤 72: close_sketch
    m.Tool_CloseSketch();
    // 步骤 73: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 76: draw_line
    m.Tool_DrawLine(-6.386, -0.335, -8.316, -1.034);
    // 步骤 77: draw_line
    m.Tool_DrawLine(-8.316, -1.034, -8.128, -2.04);
    // 步骤 78: draw_line
    m.Tool_DrawLine(-8.128, -2.04, -6.076, -1.995);
    // 步骤 79: draw_line
    m.Tool_DrawLine(-6.076, -1.995, -6.386, -0.335);
    // 步骤 80: close_sketch
    m.Tool_CloseSketch();
    // 步骤 81: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 84: draw_line
    m.Tool_DrawLine(-5.834, -2.619, -7.381, -3.968);
    // 步骤 85: draw_line
    m.Tool_DrawLine(-7.381, -3.968, -6.842, -4.838);
    // 步骤 86: draw_line
    m.Tool_DrawLine(-6.842, -4.838, -4.945, -4.055);
    // 步骤 87: draw_line
    m.Tool_DrawLine(-4.945, -4.055, -5.834, -2.619);
    // 步骤 88: close_sketch
    m.Tool_CloseSketch();
    // 步骤 89: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 92: draw_line
    m.Tool_DrawLine(-4.494, -4.55, -5.449, -6.367);
    // 步骤 93: draw_line
    m.Tool_DrawLine(-5.449, -6.367, -4.632, -6.983);
    // 步骤 94: draw_line
    m.Tool_DrawLine(-4.632, -6.983, -3.146, -5.567);
    // 步骤 95: draw_line
    m.Tool_DrawLine(-3.146, -5.567, -4.494, -4.55);
    // 步骤 96: close_sketch
    m.Tool_CloseSketch();
    // 步骤 97: extrude
    m.Tool_Extrude(4.0);
    ...
    m.Tool_CreateSketch();
    // 步骤 100: draw_line
    m.Tool_DrawLine(-2.547, -5.866, -2.781, -7.905);
    // 步骤 101: draw_line
    m.Tool_DrawLine(-2.781, -7.905, -1.797, -8.185);
    // 步骤 102: draw_line
    m.Tool_DrawLine(-1.797, -8.185, -0.923, -6.328);
    // 步骤 103: draw_line
    m.Tool_DrawLine(-0.923, -6.328, -2.547, -5.866);
    // 步骤 104: close_sketch
    m.Tool_CloseSketch();
    // 步骤 105: extrude
    m.Tool_Extrude(4.0);
    // 步骤 106: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 107: create_sketch
    m.Tool_CreateSketch();
    // 步骤 108: draw_line
    m.Tool_DrawLine(-0.256, -6.39, 0.262, -8.376);
    // 步骤 109: draw_line
    m.Tool_DrawLine(0.262, -8.376, 1.281, -8.281);
    // 步骤 110: draw_line
    m.Tool_DrawLine(1.281, -8.281, 1.426, -6.234);
    // 步骤 111: draw_line
    m.Tool_DrawLine(1.426, -6.234, -0.256, -6.39);
    // 步骤 112: close_sketch
    m.Tool_CloseSketch();
    // 步骤 113: extrude
    m.Tool_Extrude(4.0);
    // 步骤 114: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 115: create_sketch
    m.Tool_CreateSketch();
    // 步骤 116: draw_line
    m.Tool_DrawLine(2.07, -6.051, 3.27, -7.716);
    // 步骤 117: draw_line
    m.Tool_DrawLine(3.27, -7.716, 4.186, -7.259);
    // 步骤 118: draw_line
    m.Tool_DrawLine(4.186, -7.259, 3.581, -5.298);
    // 步骤 119: draw_line
    m.Tool_DrawLine(3.581, -5.298, 2.07, -6.051);
    // 步骤 120: close_sketch
    m.Tool_CloseSketch();
    // 步骤 121: extrude
    m.Tool_Extrude(4.0);
    // 步骤 122: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 123: create_sketch
    m.Tool_CreateSketch();
    // 步骤 124: draw_line
    m.Tool_DrawLine(4.116, -4.894, 5.837, -6.013);
    // 步骤 125: draw_line
    m.Tool_DrawLine(5.837, -6.013, 6.526, -5.257);
    // 步骤 126: draw_line
    m.Tool_DrawLine(6.526, -5.257, 5.253, -3.647);
    // 步骤 127: draw_line
    m.Tool_DrawLine(5.253, -3.647, 4.116, -4.894);
    // 步骤 128: close_sketch
    m.Tool_CloseSketch();
    // 步骤 129: extrude
    m.Tool_Extrude(4.0);
    // 步骤 130: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 131: create_sketch
    m.Tool_CreateSketch();
    // 步骤 132: draw_line
    m.Tool_DrawLine(5.606, -3.077, 7.615, -3.499);
    // 步骤 133: draw_line
    m.Tool_DrawLine(7.615, -3.499, 7.984, -2.545);
    // 步骤 134: draw_line
    m.Tool_DrawLine(7.984, -2.545, 6.216, -1.503);
    // 步骤 135: draw_line
    m.Tool_DrawLine(6.216, -1.503, 5.606, -3.077);
    // 步骤 136: close_sketch
    m.Tool_CloseSketch();
    // 步骤 137: extrude
    m.Tool_Extrude(4.0);
    // 步骤 138: boolean_unite
    m.Tool_BooleanUnite("", "");
    // 步骤 139: hole
    m.Tool_Hole(0.0, 0.0, 4.0, 4.0, "through");

    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_53_47_gear_17t_final_c_b97971.prt");
  }
}
