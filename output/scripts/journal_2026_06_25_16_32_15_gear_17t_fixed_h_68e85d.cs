...
public class NXJournal
{
  public static void Main(string[] args)
  {
    ...
    // 步骤 1: new_document
    m.Tool_NewDocument("2026_06_25_16_32_15_gear_17t_fixed_h_68e85d");
    // 步骤 2: cylinder
    ...
    // 步骤 5: draw_line
    m.Tool_DrawLine(8.344, -0.775, 8.344, 0.775);
    // 步骤 6: draw_line
    m.Tool_DrawLine(8.344, 0.775, 6.368, 0.592);
    // 步骤 7: draw_line
    m.Tool_DrawLine(6.368, 0.592, 6.368, -0.592);
    // 步骤 8: close_sketch
    m.Tool_CloseSketch();
    // 步骤 9: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 13: draw_line
    m.Tool_DrawLine(8.061, 2.291, 7.5, 3.737);
    // 步骤 14: draw_line
    m.Tool_DrawLine(7.5, 3.737, 5.724, 2.852);
    // 步骤 15: draw_line
    m.Tool_DrawLine(5.724, 2.852, 6.151, 1.748);
    // 步骤 16: close_sketch
    m.Tool_CloseSketch();
    // 步骤 17: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 21: draw_line
    m.Tool_DrawLine(6.689, 5.048, 5.644, 6.194);
    // 步骤 22: draw_line
    m.Tool_DrawLine(5.644, 6.194, 4.307, 4.727);
    // 步骤 23: draw_line
    m.Tool_DrawLine(4.307, 4.727, 5.104, 3.853);
    // 步骤 24: close_sketch
    m.Tool_CloseSketch();
    // 步骤 25: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 29: draw_line
    m.Tool_DrawLine(4.413, 7.124, 3.025, 7.815);
    // 步骤 30: draw_line
    m.Tool_DrawLine(3.025, 7.815, 2.309, 5.964);
    // 步骤 31: draw_line
    m.Tool_DrawLine(2.309, 5.964, 3.368, 5.436);
    // 步骤 32: close_sketch
    m.Tool_CloseSketch();
    // 步骤 33: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 37: draw_line
    m.Tool_DrawLine(1.542, 8.237, -0.002, 8.38);
    // 步骤 38: draw_line
    m.Tool_DrawLine(-0.002, 8.38, -0.002, 6.395);
    // 步骤 39: draw_line
    m.Tool_DrawLine(-0.002, 6.395, 1.177, 6.286);
    // 步骤 40: close_sketch
    m.Tool_CloseSketch();
    // 步骤 41: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 45: draw_line
    m.Tool_DrawLine(-1.538, 8.238, -3.029, 7.813);
    // 步骤 46: draw_line
    m.Tool_DrawLine(-3.029, 7.813, -2.312, 5.963);
    // 步骤 47: draw_line
    m.Tool_DrawLine(-2.312, 5.963, -1.173, 6.286);
    // 步骤 48: close_sketch
    m.Tool_CloseSketch();
    // 步骤 49: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 53: draw_line
    m.Tool_DrawLine(-4.41, 7.126, -5.647, 6.191);
    // 步骤 54: draw_line
    m.Tool_DrawLine(-5.647, 6.191, -4.31, 4.725);
    // 步骤 55: draw_line
    m.Tool_DrawLine(-4.31, 4.725, -3.365, 5.438);
    // 步骤 56: close_sketch
    m.Tool_CloseSketch();
    // 步骤 57: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 61: draw_line
    m.Tool_DrawLine(-6.686, 5.052, -7.502, 3.733);
    // 步骤 62: draw_line
    m.Tool_DrawLine(-7.502, 3.733, -5.725, 2.849);
    // 步骤 63: draw_line
    m.Tool_DrawLine(-5.725, 2.849, -5.102, 3.855);
    // 步骤 64: close_sketch
    m.Tool_CloseSketch();
    // 步骤 65: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 69: draw_line
    m.Tool_DrawLine(-8.06, 2.295, -8.344, 0.771);
    // 步骤 70: draw_line
    m.Tool_DrawLine(-8.344, 0.771, -6.368, 0.588);
    // 步骤 71: draw_line
    m.Tool_DrawLine(-6.368, 0.588, -6.15, 1.752);
    // 步骤 72: close_sketch
    m.Tool_CloseSketch();
    // 步骤 73: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 77: draw_line
    m.Tool_DrawLine(-8.344, -0.771, -8.06, -2.295);
    // 步骤 78: draw_line
    m.Tool_DrawLine(-8.06, -2.295, -6.15, -1.752);
    // 步骤 79: draw_line
    m.Tool_DrawLine(-6.15, -1.752, -6.368, -0.588);
    // 步骤 80: close_sketch
    m.Tool_CloseSketch();
    // 步骤 81: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 85: draw_line
    m.Tool_DrawLine(-7.502, -3.733, -6.686, -5.052);
    // 步骤 86: draw_line
    m.Tool_DrawLine(-6.686, -5.052, -5.102, -3.855);
    // 步骤 87: draw_line
    m.Tool_DrawLine(-5.102, -3.855, -5.725, -2.849);
    // 步骤 88: close_sketch
    m.Tool_CloseSketch();
    // 步骤 89: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 93: draw_line
    m.Tool_DrawLine(-5.647, -6.191, -4.41, -7.126);
    // 步骤 94: draw_line
    m.Tool_DrawLine(-4.41, -7.126, -3.365, -5.438);
    // 步骤 95: draw_line
    m.Tool_DrawLine(-3.365, -5.438, -4.31, -4.725);
    // 步骤 96: close_sketch
    m.Tool_CloseSketch();
    // 步骤 97: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 101: draw_line
    m.Tool_DrawLine(-3.029, -7.813, -1.538, -8.238);
    // 步骤 102: draw_line
    m.Tool_DrawLine(-1.538, -8.238, -1.173, -6.286);
    // 步骤 103: draw_line
    m.Tool_DrawLine(-1.173, -6.286, -2.312, -5.963);
    // 步骤 104: close_sketch
    m.Tool_CloseSketch();
    // 步骤 105: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 109: draw_line
    m.Tool_DrawLine(-0.002, -8.38, 1.542, -8.237);
    // 步骤 110: draw_line
    m.Tool_DrawLine(1.542, -8.237, 1.177, -6.286);
    // 步骤 111: draw_line
    m.Tool_DrawLine(1.177, -6.286, -0.002, -6.395);
    // 步骤 112: close_sketch
    m.Tool_CloseSketch();
    // 步骤 113: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 117: draw_line
    m.Tool_DrawLine(3.025, -7.815, 4.413, -7.124);
    // 步骤 118: draw_line
    m.Tool_DrawLine(4.413, -7.124, 3.368, -5.436);
    // 步骤 119: draw_line
    m.Tool_DrawLine(3.368, -5.436, 2.309, -5.964);
    // 步骤 120: close_sketch
    m.Tool_CloseSketch();
    // 步骤 121: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 125: draw_line
    m.Tool_DrawLine(5.644, -6.194, 6.689, -5.048);
    // 步骤 126: draw_line
    m.Tool_DrawLine(6.689, -5.048, 5.104, -3.853);
    // 步骤 127: draw_line
    m.Tool_DrawLine(5.104, -3.853, 4.307, -4.727);
    // 步骤 128: close_sketch
    m.Tool_CloseSketch();
    // 步骤 129: extrude
    m.Tool_Extrude(10.0);
    ...
    // 步骤 133: draw_line
    m.Tool_DrawLine(7.5, -3.737, 8.061, -2.291);
    // 步骤 134: draw_line
    m.Tool_DrawLine(8.061, -2.291, 6.151, -1.748);
    // 步骤 135: draw_line
    m.Tool_DrawLine(6.151, -1.748, 5.724, -2.852);
    // 步骤 136: close_sketch
    m.Tool_CloseSketch();
    // 步骤 137: extrude
    m.Tool_Extrude(10.0);
    ...
    m.Tool_SaveModel(@"E:\\NX\\Lang-to-NX-MCP\\output\\models\\2026_06_25_16_32_15_gear_17t_fixed_h_68e85d.prt");
  }
}
